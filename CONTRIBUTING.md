...
***Ask not what IntelliFile can do for you - ask what you can do for IntelliFile***
...
2. Include additional information such as:
    ...
    * IntelliFile Debug-Info containing:
...
1. Respect existing IntelliFile coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
