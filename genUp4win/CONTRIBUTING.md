...
***Ask not what genUp4win can do for you - ask what you can do for genUp4win***
...
2. Include additional information such as:
    ...
    * genUp4win Debug-Info containing:
...
1. Respect existing genUp4win coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
